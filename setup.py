# -*- encoding: utf-8 -*-
"""
Python setup file for the benchmarks app.
...
benchmarks/__init__.py and re-run the above command.
...
setup(
    ...
    test_suite="benchmarks.tests.runtests.runtests"
)
